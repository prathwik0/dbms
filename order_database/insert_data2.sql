...
VALUES (1000, 'Benjen Stark', 'Winterfell', 10),
    (1001, 'Petyr Baelish', 'Kings Landing', 15),
    (1002, 'Tywin Lannister', 'Casterly Rock', 20),
    (1003, 'Jaqen Hghar', 'Harrenhal', 10);
...
VALUES (500, 'Eddard Stark', 'Winterfell', 10),
    ...
    (600, 'Robert Baratheon', 'Kings Landing', 5),
    (601, 'Cersei Lannister', 'Kings Landing', 4),
    (602, 'Jaime Lannister', 'Kings Landing', 7),
    (603, 'Varys', 'Kings Landing', 6),
    (604, 'Bronn', 'Kings Landing', 8),
    (605, 'Barriston Selmy', 'Kings Landing', 10),
    ...
    (900, 'Renly Baratheon', 'Storms End', 7);
